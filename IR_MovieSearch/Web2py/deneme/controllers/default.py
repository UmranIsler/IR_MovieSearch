...
def search():
    ...
    search_result_url = "http://localhost:8983/solr/movies/select?q=genre_data:{0}+AND+{1}&start={2}&wt=json&indent=true&facet=true&facet.field=genre_data".format(genre_data, search_query, (page-1)*10)
